...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        street = "13773 Charismatic Way";
        city = "Gainesville";
        state = "VA";
        zip = "20155";
        name = "Manning";
        Publisher manning = new Publisher(street, city, state, zip, name);
        publisherRepository.save(manning);

        Author eric = new Author("Eric", "Evans");
        Book ddd = new Book("Domain Driven Design", "123456789", wrox);
        ...
        Book noEJB = new Book("J2EE Development Without EJB", "987654321", manning);
