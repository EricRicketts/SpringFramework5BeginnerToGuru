...
public class SfgDiApplication {
	...
	public static void main(String[] args) {
		...
		boolean sameBean = (singletonBeanOne == singletonBeanTwo);
		System.out.println("singletonBeanOne and singletonBeanTwo are the same: " + (sameBean));
		...
		sameBean = (prototypeBeanOne == prototypeBeanTwo);
		System.out.println("prototypeBeanOne and prototypeBeanOne are the same: " + (sameBean));
	}
